  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 gap-4">
      <div className="font-google-sans-code w-full max-w-2xl border border-foreground p-4 md:p-8">
        ...
        <p className="my-4">Si te interesa mi historia puedes dar <Link href="/blog/historia" className="cursor-none"><Highlighter action="underline" color="#E6BE3C">click acá</Highlighter></Link> y si quieres hablar conmigo abajo estan mis redes sociales.</p>
      </div>
